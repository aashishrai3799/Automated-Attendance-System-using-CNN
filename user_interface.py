...
def show():
    ...
    btn3.place(x=530, y=200, width=50)

    btn5 = tkinter.Button(bottom_frame, text = "Mark Attendance", fg = "black", bg = 'turquoise1', command = run)
    btn5.place(x=340, y=250, width=120)

    btn4 = tkinter.Button(bottom_frame, text = "EXIT", fg = "red", bg = 'indianred1', command = s_exit)
    btn4.place(x=370, y=300, width=60)
...
def show_run():
    ...
    tkinter.Label(window3, bg = 'orange').place(y = 350, width = 1400)
...
def run_attend(mode, parameters):
    final_sotware.recognize(mode, parameters)
